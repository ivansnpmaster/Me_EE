...
\begin{document}
	...
	\section{Cálculo diferencial e integral}
		...
		\input{Calculo-diferencial-e-integral/Quadratura-de-Gauss-Legendre.tex}
		
	\section{Resistência dos materiais}
		\subsection{Tensão e deformação - carregamento axial}
		\input{Resistencia-dos-materiais/Tensão-e-deformação-carregamento-axial.tex}
		
		\subsection{Deformações de barras sujeitas a cargas axiais}		
		\input{Resistencia-dos-materiais/Deformações-de-barras-sujeitas-a-cargas-axiais.tex}
		
		\subsection{Problemas envolvendo variação de temperatura}
		\input{Resistencia-dos-materiais/Problemas-envolvendo-variação-de-temperatura.tex}	
